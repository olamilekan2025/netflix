  ...
  return (
    <footer className="footer">
      ...
      <p className="footer-text">
        Your favorite place to discover movies, explore ratings,
        and watch trailers from around the world.
      </p>
      ...
      <p className="footer-copy">
        © {new Date().getFullYear()}  <span>Jel Dev </span>Movies. All rights reserved.
      </p>
